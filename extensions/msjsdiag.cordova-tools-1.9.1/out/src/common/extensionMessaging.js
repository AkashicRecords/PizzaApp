...
(function (ExtensionMessage) {
    ...
    ExtensionMessage[ExtensionMessage["GET_RUN_ARGUMENTS"] = 5] = "GET_RUN_ARGUMENTS";
    ExtensionMessage[ExtensionMessage["GET_SIMULATOR_IN_EXTERNAL_BROWSER_SETTING"] = 6] = "GET_SIMULATOR_IN_EXTERNAL_BROWSER_SETTING";
    ExtensionMessage[ExtensionMessage["GET_CORDOVA_EXECUTABLE"] = 7] = "GET_CORDOVA_EXECUTABLE";
...
class ExtensionMessageSender {
    constructor(projectRoot) {
        this.hash = hash_1.Hash.hashCode(projectRoot.toLocaleLowerCase());
    }
